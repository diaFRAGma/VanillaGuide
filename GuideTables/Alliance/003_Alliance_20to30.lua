...
-----------24-25 Ashenvale
    [2425] = {
        ...
        items = {
			...
			[4] = { str = "Töte jeden Mob auf dem Weg durch den Schrein des sengenden Feuers und töte #NPCIlkruk Magskluve# bei #COORDS(25,61)# für #DOQUESTDer Turm von Althalaxx (5)#. Er wird 2 Leerwandler beschwören, die ihm helfen.", x = 25, y = 61, zone = "Ashenvale" },
            [5] = { str = "Kämpfe dich nördlich zu #COORDS(38,34)# durch und töte #NPCDal Blutklaue# für #DOQUESTDie Auswahl der Bedrohung#.", x = 38, y = 34, zone = "Ashenvale" },
            [6] = { str = "Töte hier noch ein paar Furbolgs bis du zur Hälfte Level 25 bist." },
            [7] = { str = "Dann gehe zu Maestras Posten bei #COORDS(26,38)# und gib #TURNINDer Turm von Althalaxx (5)# ab und nimm #ACCEPTDer Turm von Althalaxx (6)# an.", x = 26, y = 38, zone = "Ashenvale" },
            [8] = { str = "Gehe nach Astranaar #COORDS(37,50)# und gebe #TURNINDie Auswahl der Bedrohung# ab.", x = 37, y = 50, zone = "Ashenvale" },
            [9] = { str = "Gehe zur Silberwindzuflucht bei #COORDS(50,67)# und nimm #ACCEPTElementararmschienen# an und erledige ihn in dem See dort.", x = 50, y = 67, zone = "Ashenvale" },
            [10] = { str = "Wenn du alle 5 intakten Elementararmschienen hast, dann benutze sie mit der Rolle der Bestimmung und gib #TURNINElementararmschienen# bei #COORDS(50,67)# ab. Magie-Beschwörer nehmen wir nicht an.", x = 50, y = 67, zone = "Ashenvale" },
            [11] = { str = "Töte hier noch ein paar Elementare bis du Level 25 erreicht hast." },
            [12] = { str = "Reise zurück nach Auberdine." },
            [13] = { str = "Geh auf das Schiff zum Hafen von Menethil. Wenn man von Auberdine kommt der linke Steg." },
        }
    },

-----------25-27 Sumpfland
    [2526] = {
        title = "25-27 Sumpfland",
        items = {
            [1] = { str = "25-27 Sumpfland" },
            [2] = { str = "Mache am Ende des Steges bei #COORDS(8,59)# Halt und nimm #ACCEPTKlauen aus der Tiefe# an.", x = 8, y = 59, zone = "Sumpfland" },
            [3] = { str = "Im westen der Stadt bei #COORDS(9,56)# nimm #ACCEPTHäute junger Krokilisken# an.", x = 9, y = 56, zone = "Sumpfland" },
			[4] = { str = "Gehe zum Eingang der Festung bei #COORDS(10,57)# und nimm #ACCEPTMeldung bei Captain Starkfaust# an.", x = 10, y = 57, zone = "Sumpfland" },
			[5] = { str = "Gehe nun nach oben in der Festung zu #COORDS(10,57)# und gib #TURNINMeldung bei Captain Starkfaust# ab und nimm #ACCEPTKriegsflaggen# an.", x = 10, y = 57, zone = "Sumpfland" },
            [6] = { str = "Im osten der Stadt bei #COORDS(12,58)# nehmen wir #ACCEPTStochern im Schlamm# an.", x = 12, y = 58, zone = "Sumpfland" },
            [7] = { str = "Vor dem Gasthaus bei #COORDS(11,60)# nehmen wir #ACCEPTDie Dritte Flotte# und #ACCEPTDer Sumpfhüter# an.", x = 11, y = 60, zone = "Sumpfland" },
            [8] = { str = "Gehe zu #COORDS(49,56)# und kämpfe dich nach Norden zu #COORDS(53,46) und gib #TURNINRaenes Säuberung (3)# an und nimm #ACCEPTRaenes Säuberung (4)# an.", x = 53, y = 46, zone = "Sumpfland" },
            [9] = { str = "Make Menethil Harbor your home" },
            [10] = { str = "Go upstairs in the inn, turn in  The Absent Minded Prospector pt.4  accept  The Absent Minded Prospector pt.5" },
            [11] = { str = "Buy a  Flagon of Mead  from the bartender for  Die Dritte Flotte  and give it to the guy outside the inn. Accept  The Cursed Crew " },
            [12] = { str = "On the bridge accept  In Search of the Excavation Team pt.1" },
            [13] = { str = "Kill Young Crocolisks just east of the bridge around 14,52 and north on the land of the lake also along the road to Der Sumpfhüter for  Häute junger Krokilisken ", x = 14, y = 52, zone = "Sumpfland" },
            [14] = { str = "Kill Bluegill Murlocs and Gobbler at 18,40 for  Klauen aus der Tiefe", x = 18, y = 40, zone = "Sumpfland" },
            [15] = { str = "Kill Mottled Raptors and Screechers around 25,46 for  The Absent Minded Prospector pt.5", x = 25, y = 46, zone = "Sumpfland" },
            [16] = { str = "Enter the Excavation Site at 34,40.", x = 34, y = 40, zone = "Sumpfland" },
            [17] = { str = "Run up the path on the left and grab the fossil near the 2 npc’s at 38,52 for  The Absent Minded Prospector pt.5", x = 38, y = 52, zone = "Sumpfland" },
            [18] = { str = "Turn in  In Search of the Excavation Team pt.1  accept  In Search of the Excavation Team pt.2" },
            [19] = { str = "Accept  Uncovering the Past." },
            [20] = { str = "Outside the cave accept  Ormer s Revenge pt.1." },
            [21] = { str = "Go back to where you killed the raptors a few minutes ago at 25,46 and do  Ormer's Revenge pt.1  by killing mottled raptors and screechers.", x = 25, y = 46, zone = "Sumpfland" },
            [22] = { str = "Run back up to the cave at 38,52 and turn in  Ormer's Revenge pt.1  accept  Ormer’s Revenge pt.2", x = 38, y = 52, zone = "Sumpfland" },
            [23] = { str = "Now do both  Ormer’s Revenge pt.2  by killing Scythclaw and Razormaw Raptors below, and  Uncovering the Past  relics for this are all around the raptors. There are 4 different ones that randomly spawn but each is in it’s own shape which are: (Modr=Thin Red Vase) (Golm=Fat Yellow Vase) (Neru=Dirt Pile) (Ados=Tomb)." },
            [24] = { str = "Go back up to 38,52 and turn in  Ormer’s Revenge pt.2  accept  Ormer’s Revenge pt.3", x = 38, y = 52, zone = "Sumpfland" },
            [25] = { str = "Turn in  Uncovering the Past" },
            [26] = { str = "Do  Ormer’s Revenge pt.3  atop the hill at 32,51 Sarltooth is a 29 But he’s as easy as the others. Go turn it back in at 38,52.", x = 32, y = 51, zone = "Sumpfland" },
            [27] = { str = "Go in to Angerfang Encampment at 43,40 and do  Kriegsflaggen", x = 43, y = 40, zone = "Sumpfland" },
            [28] = { str = "Stop at 49,39 accept Daily Delivery.", x = 49, y = 39, zone = "Sumpfland" },
            [29] = { str = "Run straight East from here to 56,40 and turn in  Der Sumpfhüter  accept  Tramping Paws", x = 56, y = 40, zone = "Sumpfland" },
            [30] = { str = "Kill Mosshide around 56,74 for  Tramping Paws  at the camp. They’re a fast respawn I couldn’t kill em fast enough. Turn it in at 56,40 and accept  Fire Taboo  You should be 26 by now, if not you will be soon", x = 56, y = 74, zone = "Sumpfland" },
            [31] = { str = "Do  Fire Taboo  by killing any mosshides but the ones you just killed, The flints are easily dropped by the ones around 44,33 there is a few.", x = 44, y = 33, zone = "Sumpfland" },
            [32] = { str = "Turn in  Fire Taboo  at 56,40 accept  Blisters on the Land  Now this is one of those quests you just do as you go. Fen Creepers are stealthed elementals that lurk in the water. If you see one, kill it.", x = 56, y = 40, zone = "Sumpfland" },
            [33] = { str = "Hearth back to Menethil Harbor." },
            [34] = { str = "Turn in  The Absent Minded Prospector pt.5  2nd floor of the Inn" },
            [35] = { str = "Go inside the castle upstairs, turn in  Kriegsflaggen  accept  Nek'Rosh's Gambit" },
            [36] = { str = "On the west side of town hand in Daily Delivery and  Häute junger Krokilisken  accept  Apprentice's Duties" },
            [37] = { str = "Go on the dock and turn in  Klauen aus der Tiefe  accept  Reclaiming Goods" },
            [38] = { str = "On the bridge hand in  In Search of the Excavation Team pt.2." },
            [39] = { str = "You should definitely be 26 by this point and near ½ way to 27. You can either wait till you fly through IF to get talents or do it now." },
            [40] = { str = "Touch the damaged crate at 13,41 turn in  Reclaiming Goods  accept  The Search Continues.", x = 13, y = 41, zone = "Sumpfland" },
            [41] = { str = "Go just north to the next camp Touch the sealed barrel at 13,38 turn in  The Search Continues  accept  Search More Hovels.", x = 13, y = 38, zone = "Sumpfland" },
            [42] = { str = "Go north again touch the half-burried barrel at 13,34 turn in  Search More Hovels  accept  Return the Statuette", x = 13, y = 34, zone = "Sumpfland" },
            [43] = { str = "Stop at the sunken ships around 14,28 14,25 and kill the unded on either ship for  The Cursed Crew  Try to stay on top of the ships. Kill Snellig in the broken part of the first ship in the rear near the shore for the box.", x = 14, y = 28, zone = "Sumpfland" },
            [44] = { str = "From here north you should be able to find Giant crocolisks for  Apprentice's Duties  as well as the fen dwellers (track hidden) in the waters all over this area while you head toward Ironbeard’s Tomb at 44,25 for  Stochern im Schlamm  Kill oozes for the bag.", x = 44, y = 25, zone = "Sumpfland" },
            [45] = { str = "Now once all your fen creepers are dead head back to Der Sumpfhüter at 56,40 and hand it in.", x = 56, y = 40, zone = "Sumpfland" },
            [46] = { str = "Hearth Back to Menethil Harbor." },
            [47] = { str = "Just outside hand in  The Cursed Crew  accept  Lifting the Curse." },
            [48] = { str = "Go north a little bit and hand in  Stochern im Schlamm" },
            [49] = { str = "Go to the west side of town, turn in  Apprentice's Duties." },
            [50] = { str = "Next down to the docks, hand in  Return the Statuette" },
            [51] = { str = "You should be 27 now. " },
            [52] = { str = "Fly to IF, get new skills, hand in  Ein alter Kollege  at 71,51 SKIP the next part +von mirko Die Macht in der Tiefe abgeben", x = 71, y = 51, zone = "Sumpfland" },
            [53] = { str = "Fly to SW, hand in  Der Aufschub des Gnoms  at 43,80 SKIP the next part", x = 43, y = 80, zone = "Sumpfland" },
            [54] = { str = "Fly to Lakeshire" },
        }
    },
...
-----------30-30 Sumpfland
    --[210] = {
    [3030] = {
        title = "30-30 Sumpfland",
        --n = "30-30 Sumpfland",
        --pID = 209, nID = 301,
        --itemCount = 18,
        items = {
            [1] = { str = "30-30 Sumpfland" },
            [2] = { str = "Make Menethil Harbor your home." },
            [3] = { str = "Go to 14,25 and kill Captain Halyndor for his key on top of the ship, the chest is in the bottom of the ship. Send your pet in to grab all the aggro, then send it out to attack a murloc so it trains them all out. Touch the chest and turn in  Lifting the Curse  accept  The Eye of Paleth", x = 14, y = 25, zone = "Sumpfland" },
            [4] = { str = "Touch the catapult at 47,47, hand in  Nek'Rosh's Gambit  accept  Defeat Nek’Rosh", x = 47, y = 47, zone = "Sumpfland" },
            [5] = { str = "Go to 53,55 and clear the left side, walk up and around the back, to do  Defeat Nek’Rosh  clear anything he might aggro, die doing so if you must. He’s kinda weak. Pretty easy for a 32 elite.", x = 53, y = 55, zone = "Sumpfland" },
            ...
            [10] = { str = "Turn in  Fall of Dun Modr  at 49,18 accept  The Thandol Span pt.1", x = 49, y = 18, zone = "Sumpfland" },
            [11] = { str = "Go half way across the bridge to 51,8 and go in the door that leads down, look for the dead dwarf body, hand in  The Thandol Span pt.1  accept  The Thandol Span pt.2  turn that back in at the camp at 49,18 accept  The Thandol Span pt.3 ", x = 51, y = 8, zone = "Sumpfland" },
            [12] = { str = "Go back over the bridge, just to the right is a tinier bridge. Cross it and destroy the explosives cart for  The Thandol Span pt.3  at 48,88 accept  Plea to the Alliance", x = 48, y = 88, zone = "Sumpfland" },
